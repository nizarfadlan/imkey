...
export default function Hero({ servicesRef }) {
  ...
  return (
    <>
      <div className="container py-28 md:py-32 px-4 sm:px-6 lg:px-14 xl:px-18 mx-auto relative flex flex-col items-center z-30">
        <div className="hero-text flex flex-col items-center text-center">
          <motion.h1
            initial="initial"
            animate="animate"
            variants={fadeInSide('left', 1.4)}
            className="font-bold text-4xl lg:text-5xl max-w-xl text-dark"
          >
          ...
          <motion.p
            ...
            className="text-gray-700 text-base leading-relaxed mt-4 font-medium max-w-lg"
          >
